...
cmds=OrderedDict([("MIELD","Calculate Mean Methylation Ratio and Methylation-Interruption-Evaluated Local Discordance(MIELD) of each CpG from BSMAP alignments."),\
...
def main(cmd=''):
    ...
    if cmd=='MIELD':
        ...
        parser.add_argument('-o', '--out_prefix',dest="out_prefix",metavar='PREFIX',default='out',\
                            help="Prefix of output files saving MethRatio or MIELD for each CpG.")
        parser.add_argument('-w', '--wig_prefix',dest="wig_prefix",metavar='PREFIX',default=None,\
                            help="Prefix of wiggle files saving MethRatio or MIELD. As default, NO wiggle file is saved.")
    ...
    if cmd=="BedRatio":
        ...
        parser.add_argument('Ratio',default=None,\
                            help="MethRatio or MIELD file generated by 'MIELD' command")
    ...
    if cmd=='MIELD':
        ...
        # Output MIELD,MethRatio files and wiggle file
        if args.CT_SNP > 0:
            Out_MIELD(out_prefix=args.out_prefix,wig_prefix=args.wig_prefix,wig_bin=args.wig_bin,min_depth=args.min_depth,ref=ref,refmark=refmark,CT_SNP=args.CT_SNP,seq_context=seq_context,\
